package Articles.Variance

/**
 * Created by Daniel.
 * Copy from https://github.com/rockthejvm/advanced-scala/blob/master/src/lectures/part5ts/Variance.scala
 */
object Variance extends App {
  ...
  //    val catCage: XCage[Cat] = new XCage[Animal](new Crocodile) // TODO ???
...
//    class CovariantVariableCage[+T](var animal: T) // types of vars are in CONTRAVARIANT POSITION
  ...
  val evenMoreAnimals = moreAnimals.add(new Dog) // not going to work as
